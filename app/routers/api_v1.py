...
def _create_uploaded_item(
    *,
    ...
    item = Item(
        ...
        media_conversion_profile=labeling_proxy_profile_token() if prepared.kind == ItemKind.video else None,
...
def get_item_media(
    ...
    return FileResponse(path=file_path, media_type=guess_media_type(file_path))
